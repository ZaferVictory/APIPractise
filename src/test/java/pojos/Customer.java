...
public class Customer {
   ...
   private user user;
    ...
    public Customer(int id, String firstName, String lastName, String middleInitial, String email, String mobilePhoneNumber, String phoneNumber, String zipCode, String address, String ssn, String city, String createDate, Boolean zelleEnrolled, Country country, String state, pojos.user user) {
        this.id = id;
